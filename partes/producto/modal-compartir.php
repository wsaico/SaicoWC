<?php
/**
 * Modal de Compartir - Opciones de redes sociales
 */
...
<div id="saico-share-modal" class="saico-modal saico-share-modal">
    ...
    <div class="saico-modal-contenido share-modal-content">
        ...
        <div class="share-options">
            ...
            <!-- WhatsApp -->
            <button class="share-btn share-btn-whatsapp" onclick="window.open('https://wa.me/?text=' + encodeURIComponent('<?php echo esc_js($product_title); ?> - <?php echo esc_js($product_url); ?>'), '_blank'); saicoCerrarModal('saico-share-modal');">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <!-- Telegram -->
            <button class="share-btn share-btn-telegram" onclick="window.open('https://t.me/share/url?url=' + encodeURIComponent('<?php echo esc_js($product_url); ?>') + '&text=' + encodeURIComponent('<?php echo esc_js($product_title); ?>'), '_blank'); saicoCerrarModal('saico-share-modal');">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
